...
export default function TextEditor (props) {
  ...
  const editorInit = () => {
    //console.log(props);
    console.log("editör init");
    tinymce.init({
      selector: 'div.tinyEditor' + (name?name:props.langId + '_' + props.valueSlug),
      ...
      setup: function (ed) {
        ...
        ed.on("change", function () {
          ...
          //let gonder = {name: name,value: ed.getBody().innerHTML}
          let gonder = {target:{name:name, value: ed.getBody().innerHTML}}
          onChange(gonder);
  ...
  return(
    <div className={'tinyEditor' + (name?name:props.langId + '_' + props.valueSlug)} name={name}  ></div>
  )
}